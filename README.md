...
If you're planning to use the [Blueprint](http://compass-style.org/docs/reference/blueprint/) extension from Compass, you should remove the reset and fonts styles (imported on line 19 and 20) of HTML Starter's `style.scss` file. Blueprint already includes a reset and some basic typographic styles.
